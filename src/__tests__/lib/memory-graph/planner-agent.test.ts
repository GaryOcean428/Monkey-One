...
describe('PlannerAgent', () => {
  ...
  describe('Configuration Gap Analysis', () => {
    ...
    it('should prioritize critical configurations', async () => {
      ...
      const criticalConfigRec = recommendations.find(r => r.action.includes('DATABASE_URL'))
      const nonCriticalConfigRec = recommendations.find(r => r.action.includes('API_KEY'))
