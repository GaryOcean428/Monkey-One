...
describe('ToolPipeline', () => {
  ...
  describe('tool registration', () => {
    ...
    it('should prevent duplicate tool registration', () => {
      const tool = createMockTool('test')
      pipeline.registerTool(tool, { timeout: DEFAULT_TIMEOUT })
      expect(() => pipeline.registerTool(tool, { timeout: DEFAULT_TIMEOUT })).toThrow(
        ToolExecutionError
      )
    })
    ...
    it('should validate tool definition', () => {
      ...
      expect(() => pipeline.registerTool(invalidTool, { timeout: DEFAULT_TIMEOUT })).toThrow(
        ToolExecutionError
      )
    })
  ...
  describe('tool execution', () => {
    ...
    it('should handle rate limiting', async () => {
      ...
      await expect(pipeline.executeTool('limited', {})).rejects.toThrow(/Rate limit exceeded/)
    })
    ...
    it('should reset rate limit after cooldown', async () => {
      ...
      await expect(pipeline.executeTool('limited', {})).resolves.toBeDefined()
    })
  })
  ...
  describe('parallel execution', () => {
    ...
    it('should handle errors in parallel execution', async () => {
      ...
      await expect(pipeline.executeBatch(executions, true)).rejects.toThrow('Failed')
    })
  })
  ...
  describe('dependencies', () => {
    it('should validate tool dependencies', async () => {
      ...
      await expect(pipeline.executeTool('dependent', {})).rejects.toThrow(/Missing dependency/)
    })
    ...
    it('should allow execution when dependencies are met', async () => {
      ...
      await expect(pipeline.executeTool('dependent', {})).resolves.toBeDefined()
    })
  ...
  describe('error handling', () => {
    ...
    it('should handle non-Error exceptions', async () => {
      ...
      await expect(pipeline.executeTool('failing', {})).rejects.toThrow()
    })
  })
})
