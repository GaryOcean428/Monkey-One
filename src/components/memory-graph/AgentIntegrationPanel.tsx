              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      setQueryForm(prev => ({ ...prev, maxResults: parseInt(e.target.value) }))
                    }
                    min="1"
                    max="100"
                  />
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      setMessageForm(prev => ({ ...prev, type: e.target.value as any }))
                    }
                    className="mt-1 w-full rounded-md border px-3 py-2"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      setMessageForm(prev => ({ ...prev, priority: e.target.value as any }))
                    }
                    className="mt-1 w-full rounded-md border px-3 py-2"
                  >
                      ...
                      <div key={index} className="rounded bg-gray-50 p-2 text-sm">
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          ...
                          <span className="text-xs text-gray-500">
                            {capability.inputTypes.length} inputs • {capability.outputTypes.length}{' '}
                            outputs
                          </span>
                        </div>
                      </div>
