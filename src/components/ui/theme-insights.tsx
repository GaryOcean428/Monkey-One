  ...
  return (
    <Card className={cn('w-full', className)}>
      <CardHeader>
        ...
        <CardDescription>Your personalization patterns and usage statistics</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          ...
          <div className="space-y-2">
            ...
            <Badge
              variant={getEngagementBadgeVariant(insights.engagementLevel)}
              className="text-sm"
            >
              {insights.engagementLevel}
            </Badge>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            {Object.entries(insights.themeUsageDistribution).map(([mode, count]) => (
              <div key={mode} className="bg-muted/50 rounded-lg p-3 text-center">
                <div className="text-lg font-semibold">{count}</div>
                <div className="text-muted-foreground text-sm capitalize">{mode}</div>
              </div>
            ))}
          </div>
        </div>
