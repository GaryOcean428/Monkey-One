...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    ...
    >
      ...
      />
      <Button type="button" onClick={handleClear} disabled={disabled} variant="ghost" size="icon">
        <X className="h-5 w-5" />
      </Button>
      <Button
        type="button"
      ...
      <Button type="submit" disabled={!message.trim() || disabled} variant="ghost" size="icon">
