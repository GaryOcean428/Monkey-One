...
export class HandoffManager {
  ...
  async evaluateHandoff(message: Message, agent?: Agent): Promise<{ requiredCapabilities: string[] } | null> {
  ...
  async findBestAgent(requiredCapabilities: string[], availableAgents: Agent[]): Promise<Agent | null> {
