...
export class ResponseCache {
  ...
  private generateKey(cacheKey: string, options: Record<string, unknown>): string {
  ...
  set(cacheKey: string, options: Record<string, unknown>, response: ModelResponse): void {
  ...
  get(cacheKey: string, options: Record<string, unknown>): ModelResponse | null {
    const key = this.generateKey(cacheKey, options)
