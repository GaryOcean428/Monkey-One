...
export function usePersistedMemoryGraph(adapter: StorageAdapter): UseMemoryGraphReturn & {
  save: () => Promise<void>
  load: () => Promise<void>
  isLoading: boolean
} {
...
export const examples = {
  ...
  persistenceUsage: () => {
    ...
    const { graph, ingestor, planner, save, load, isLoading } = usePersistedMemoryGraph(adapter)
